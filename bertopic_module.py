...
class BERTopicProcessor:
    def __init__(self, num_topics=None):
        ...
        """
        if num_topics == 'auto':
            self.num_topics = None  # BERTopic will automatically determine the number of topics
...
class BERTopicCSVDataSaver:
    def __init__(self, dataset_handler, bertopic_processor):
        ...
        self.bertopic_processor = bertopic_processor  # Assigning the BERTopicProcessor object
